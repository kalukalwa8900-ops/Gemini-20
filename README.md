...
A simple Flask web app that uses Google's **Gemini 2.5 Flash** model to generate images from text prompts. Deploy for free on Railway.
...
> Free tier: **250 image generations per day**
